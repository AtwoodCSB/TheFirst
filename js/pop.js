...
(function() {
	...
	getPage = function(win){
		var dd = win ? win.document.documentElement : document.documentElement,
			...
			dom = dd || db;
		return {
			width:  Math.max(dom.clientWidth, dom.scrollWidth)+30,		// 页面宽度
			height: Math.max(dom.clientHeight, dom.scrollHeight)+30,	// 页面长度
